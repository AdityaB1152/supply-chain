...
function Track() {
  ...
  const loadBlockchaindata = async () => {
    ...
    if (networkData) {
      ...
      const CropStage = [];
      for (i = 0; i < CropCtr; i++) {
        Crop[i + 1] = await supplychain.methods.CropStock(i + 1).call();
        CropStage[i + 1] = await supplychain.methods.showStage(i + 1).call();
      }
      setCrop(Crop);
      ...
      <div className="container-xl">
        ...
        <section className="row">
          <article className="col-3">
            ...
            <p>
              <b>Supplier ID: </b>
              {RMS[Crop[ID].RMSid].id}
            </p>
            <p>
              <b>Name:</b> {RMS[Crop[ID].RMSid].name}
            </p>
            <p>
              <b>Place: </b>
              {RMS[Crop[ID].RMSid].place}
            </p>
          </article>
          <span>&#10132;</span>
          <article className="col-3">
            ...
            <p>
              <b>Manufacturer ID: </b>
              {MAN[Crop[ID].MANid].id}
            </p>
            <p>
              <b>Name:</b> {MAN[Crop[ID].MANid].name}
            </p>
            <p>
              <b>Place: </b>
              {MAN[Crop[ID].MANid].place}
            </p>
          </article>
          <span>&#10132;</span>
          <article className="col-3">
            ...
            <p>
              <b>Distributor ID: </b>
              {DIS[Crop[ID].DISid].id}
            </p>
            <p>
              <b>Name:</b> {DIS[Crop[ID].DISid].name}
            </p>
            <p>
              <b>Place: </b>
              {DIS[Crop[ID].DISid].place}
            </p>
          </article>
          <span>&#10132;</span>
          <article className="col-3">
            ...
            <p>
              <b>Retailer ID: </b>
              {RET[Crop[ID].RETid].id}
            </p>
            <p>
              <b>Name:</b> {RET[Crop[ID].RETid].name}
            </p>
            <p>
              <b>Place: </b>
              {RET[Crop[ID].RETid].place}
            </p>
          </article>
          <span>&#10132;</span>
          <article className="col-3">
      ...
      <div className="container-xl">
        ...
        {/* <section className="row">
                    ...
                    <article className="col-3">
                        ...
                        <p><b>Supplier ID: </b>{RMS[Crop[ID].RMSid].id}</p>
                        <p><b>Name:</b> {RMS[Crop[ID].RMSid].name}</p>
                        <p><b>Place: </b>{RMS[Crop[ID].RMSid].place}</p>
                    </article>
                </section> */}
      </div>
    );
  ...
  const handlerSubmit = async (event) => {
    ...
    var ctr = await SupplyChain.methods.CropCtr().call();
    if (!(ID > 0 && ID <= ctr)) alert("Invalid crop ID!!!");
    else {
      // eslint-disable-next-line
      if (Crop[ID].stage == 5) showTrackTillSold(true);
      // eslint-disable-next-line
      else if (Crop[ID].stage == 4) showTrackTillRetail(true);
      // eslint-disable-next-line
      else if (Crop[ID].stage == 3) showTrackTillDistribution(true);
      // eslint-disable-next-line
      else if (Crop[ID].stage == 2) showTrackTillManufacture(true);
      // eslint-disable-next-line
      else if (Crop[ID].stage == 1) showTrackTillRMS(true);
  ...
  return (
    <div>
      ...
      <h5>Enter crop ID to Track it</h5>
